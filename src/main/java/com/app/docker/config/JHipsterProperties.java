...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "dockerTest@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "dockerTest API";

        private String description = "dockerTest API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "dockerTest";
